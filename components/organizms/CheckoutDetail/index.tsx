...
export default function CheckoutDetail() {
	const [dataTopup, setDataTopup] = useState({
		verifyID: "",
		nominalItem: { _id: "", price: 0, coinQuantity: 0, coinName: "" },
		paymentItem: { payment: { _id: "", type: "" }, bank: { _id: "", bankName: "", name: "", noRekening: "" } },
		bankAccountName: "",
	});
		...
		<>
			<div className="purchase pt-md-50 pt-30">
				...
				<p className="text-lg color-palette-1 mb-20">
					...
					<span className="purchase-details">
						{" "}
						<NumericFormat value={tax} displayType={"text"} prefix={"Rp "} thousandSeparator={true} />
					</span>
				</p>
				<p className="text-lg color-palette-1 mb-20">
					Total{" "}
					<span className="purchase-details color-palette-4">
						<NumericFormat value={totalPrice} displayType={"text"} prefix={"Rp "} thousandSeparator={true} />
					</span>
				</p>
			</div>
